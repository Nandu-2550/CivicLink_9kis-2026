...
export const api = {
  ...
  forgotPassword: (email) => apiFetch("/api/auth/forgot-password", { body: { email } }),
  resetPassword: (email, otp, newPassword) => apiFetch("/api/auth/reset-password", { body: { email, otp, newPassword } }),
