...
export const api = {
  ...
  forgotPassword: (identifier) => apiFetch("/api/auth/forgot-password", { body: { identifier } }),
  resetPassword: (identifier, otp, newPassword) => apiFetch("/api/auth/reset-password", { body: { identifier, otp, newPassword } }),
